...
router.post("/", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    if (metadata.clientCompressed) {
      ...
      uploadMetadata["x-amz-meta-compression-quality"] =
        metadata.compressionQuality || "unknown";
      if (metadata.originalSize) {
        uploadMetadata["x-amz-meta-original-size"] =
          metadata.originalSize.toString();
      }
      if (metadata.compressionRatio) {
        uploadMetadata["x-amz-meta-compression-ratio"] =
